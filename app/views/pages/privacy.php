...
<section class="about-page">
  <div class="container">
    ...
    <p>
      We understand your fears and concerns regarding the privacy of your data on the internet. We have prepared this policy to help you understand the nature of the data we collect from your when visiting <?php echo SITENAME; ?> and how we use this personal data.
    </p>
    <hr />
    ...
    <h4 class="bold">Network Surveys</h4>
    <p>
    ...
    <h4 class="bold">Links to External Sites</h4>
    <p>
 ...
 We may be assisted by third party advertising companies for the reason of displaying ads when you visit our website. These companies have the right to use information about your visit to this website and other websites (excluding the name, address or email or phone). This is to provide ads about products or services that you care about.
    ...
    <h4 class="bold">Disclosure of Information</h4>
    <p>
    ...
    <h4 class="bold">Required Data to do the necessary procedures from your side</h4>
    <p>
    ...
    <h4 class="bold">When Contacting Us</h4>
    <p>
    ...
    <h4 class="bold">Disclosure of Information to Third Parties</h4>
    <p>
    ...
    <h4 class="bold">Modification of Data Confidentiality and Privacy Policy</h4>
    <p>
